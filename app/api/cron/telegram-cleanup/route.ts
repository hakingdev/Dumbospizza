 ...
 *
 * Если настроена тема «🗂 Архив» (telegramTopicArchive / TELEGRAM_TOPIC_ARCHIVE),
 * карточки переезжают туда; без неё — просто удаляются. К утру темы статусов
 * («Доставлен» и остальные) в любом случае пустые.
 *
